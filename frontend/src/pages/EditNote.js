...
export default class EditNote extends Component {
    ...
    componentDidMount() {
        ...
        axios.put(`http://localhost:3000/entries/${noteId}`)
            .then(response => {
                this.setState({
    ...
    handleDelete(e) {
        ...
        axios.delete(`http://localhost:3000/entries/${this.props.match.params.id}`)
            .then(response => {
    ...
    handleSave(e) {
        ...
        axios.patch(`http://localhost:3005/entries/${this.props.match.params.id}`, {
